...
const words = ["Mobile Apps", "Flutter Experiences", "Scalable Solutions", "Clean Architecture"];
let wordIndex = 0;
let charIndex = 0;
...
const sections = document.querySelectorAll('.card, .premium-project, .skills-category, .certificate-card');
sections.forEach(el => {
  el.style.opacity = "0";
